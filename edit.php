...
<body>
    <div class="nav">
        ...
        <div class="right-links">
            ...
            <a href='doctor.php'> <button class='btn'><i class='fa-solid fa-hospital-user'></i></button> </a>
            <a href='php/logout.php'> <button class='btn'><i class='fa-solid fa-right-from-bracket'></i></button> </a>
        </div>
    </div>
    <div class="container">
